jQuery(document).ready(function($) {
    console.log('=== General Options Script Loaded ===');
    ...
    function togglePreloaderFields() {
        ...
        console.log('Toggling preloader fields, checked:', isChecked);
    }
    ...
    $('select[name="ross_theme_general_options[base_font_family]"]').on('change', function() {
        var font = $(this).val();
    ...
    console.log('=== General Options Script Ready ===');
});
